        ...
        if response.status_code == 200:
          ...
          for model in data.get("data", []):
            ...
            models.append({
              ...
              "supports_vision": "vision" in model_id.lower() or "pixtral" in model_id.lower(),
              "supports_reasoning": "mistral-large" in model_id.lower() or "reasoning" in model_id.lower(),
